...
namespace {
struct qt_meta_tag_ZN6BuscarE_t {};
} // unnamed namespace

template <> constexpr inline auto Buscar::qt_create_metaobjectdata<qt_meta_tag_ZN6BuscarE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Buscar, qt_meta_tag_ZN6BuscarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Buscar::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6BuscarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6BuscarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN6BuscarE_t>.metaTypes,
    nullptr
} };
...
void Buscar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_btnVolver_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *Buscar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN6BuscarE_t>.strings))
